...
var size = 1000;
  ...
  */
  ...
  static _sava3(key: string,object: any,expires: number){
    this.isInit();
    storage.save({
  ...
  static _sava(key:string,object:any){
  ...
  static _clearDataByKey(key:string){
    this.isInit();
    // !! 清除某个key下的所有数据
 ...
 static async _load(key: string){
    return await this._load3(key,null,null);
 }


  static _load3(key: string,params: null,someFlag: null){
    this.isInit();
